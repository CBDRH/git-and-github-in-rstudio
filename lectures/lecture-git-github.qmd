...
1. Click here and follow the directions to create a personal fork of the **Exercises** repo on GitHub

Clone this repo as a new project in RStudio

1. Click on the Code icon and copy the **HTTPS** url to your clipboard

1. In RStudio, create a new project using this url:
